    ...
    public function plugin_settings_page() {
        ...
        ?>
            <div class="wrap">
              ...
              <?php else :  ?>
                  <p><?php printf( __( 'To use the OpenOTP plugin on Wordpress, you must download and configure OpenOTP server <a href="%1$s"><strong>%1$s</strong></a>.', 'openotp' ), 'http://www.rcdevs.com' ); ?></p>
    ...
    */
	...
	public function openotp_AddJSToLogin(){
		if($this->show_openotp_challenge){
			...
			wp_enqueue_script( 'fidou2f', plugin_dir_url( __FILE__ ) . 'fidou2f.js',null,'',true);
